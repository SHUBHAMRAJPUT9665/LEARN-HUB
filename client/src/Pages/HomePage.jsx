    ...
    <HomeLayout>
      <div className="pt-10 text-white flex flex-col-reverse lg:flex-row items-center justify-center gap-10 mx-6 md:mx-16 h-auto lg:h-[90vh]">
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold">
            Find out best
            <span className="text-yellow-500 mx-3 font-bold">Online courses</span>
          </h1>
          ...
          <div className="space-y-4 md:space-y-0 flex flex-col md:flex-row justify-center lg:justify-start gap-4">
            <Link to="/courses">
      ...
      <div className="flex flex-col justify-center items-center pt-10">
        <h1 className="text-xl md:text-2xl lg:text-2xl font-semibold">
          Welcome to
          <span className="text-yellow-500 mx-3 font-bold">LEARN HUB!</span>
        </h1>
        <div className="flex p-5 justify-between items-center gap-5">
          <p className="font-semibold text-white text-center text-sm md:text-xl lg:text-2xl">
            <span className="text-[#5FA349]">2500</span> + Members
          </p>
          <p className="text-xl font-bold text-white">|</p>
          <p className="font-semibold text-center text-white text-sm md:text-xl lg:text-2xl">
            213 joined this month
          </p>
        </div>
      </div>
